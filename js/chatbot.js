    ...
    var Hn = Mn && Mn.isArrayBuffer,
        ...
        it = function w(En) {
            ...
            return On.after = function(n, t) {
                ...
                if (n = { start: f, end: n }, o = n.start, f = n.end, n = f - o, o = u ? f : o - 1, f = this.__iteratees__, c = f.length, a = 0, l = Mi(n, this.__takeCount__), !e || !u && i == n && l == n) return kr(t, this.__actions__);
                e = [];
                n: for (; n-- && a < l;) {
...
var SoGeYoung = {
    ...
    collectAnswers: function(question, answer) {
        ...
        if (!isOptionsQuestion(question)) ans = answer;
        else ans = question.options[answer].text;
